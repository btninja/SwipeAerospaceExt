...
case "$cask_name" in
    swipeaerospace-extended) ;;
    *) echo "Unknown cask name: $cask_name. Allowed cask names: swipeaerospace-extended" > /dev/stderr; exit 1;;
esac
...
zip_root_dir="SwipeAeroSpaceExtended-v$build_version"
